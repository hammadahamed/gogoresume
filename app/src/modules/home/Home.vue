    ...
    <div class="" :class="{
        ...
        <div class="max-w-[900px] mx-auto px-6 py-16">
            ...
            <div class="text-center mb-22">
                <p class="text-3xl font-bold text-gray-900 mb-2 leading-tight" :class="{
            ...
            <div class="mb-20">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div v-for="(step, index) in steps" :key="step.id"
                        class="bg-white border-3 border-gray-900 hover:-translate-y-1 hover:scale-101 hover:shadow-sm transition-all duration-300 overflow-hidden flex flex-col h-full">
              ...
              >
                {{ index + 1 }}
                        ...
                        <div class="p-5 flex flex-col flex-grow" :class="{ 'h-60': !homeView }">
                            <!-- Text Content -->
                            ...
                            <div v-if="!homeView" class="mt-auto">
                                <SpecialBtn :text="step.buttonText" size="default" :variant="step.buttonVariant"
                                    :primaryColor="'black'" :secondaryColor="'white'" :textColor="'white'"
                                    class="hover:opacity-70 transition-all duration-300 shadow-lg"
