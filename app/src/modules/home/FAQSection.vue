    ...
    <section id="faq" class="py-16 mb-24 sm:py-20 lg:py-24 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-16 sm:mb-20">
                <div class="inline-flex items-center gap-2 px-3 py-1 bg-gray-100 rounded-full mb-6">
            ...
            <div class="space-y-2">
                <!-- FAQ Items -->
                <div v-for="(faq, index) in faqItems" :key="index" class="faq-item group"
                    :class="{ active: openFaqs[index] }">
                    <button @click="toggleFaq(index)" class="faq-question">
                        <span class="faq-text">{{ faq.question }}</span>
                        <svg class="faq-icon" :class="{ 'rotate-180': openFaqs[index] }" fill="none"
