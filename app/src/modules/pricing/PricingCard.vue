  ...
  >
    ...
    <div class="pricing-card__header" style="margin: 0px; margin-top: 30px">
      ...
      <div class="flex items-center justify-center gap-1">
        ...
        >
          <div
            class="text-lg flex justify-center items-center diagonal-strike text-gray-500 relative"
          >
      ...
      <div class="mb-8 -mt-3">
        <h3 class="font-bold text-lg text-center -ml-1">
          {{ plan.name }}
        </h3>
      </div>
    </div>
    ...
    <div class="pricing-card__features">
      <ul>
        <li v-for="feature in plan.features" :key="feature">
          <div
            class="w-5 h-5 rounded-full flex items-center justify-center p-2 bg-violet-500/10"
          >
