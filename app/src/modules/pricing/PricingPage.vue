...
<template>
    <div class="pricing-page pb-0">
        <div class="pricing-page__header" v-if="!route.meta.restrictPlan && !homeView">
            <h1>
                Screw the ATS ,
            ...
            <p class="">
                ...
                <span class="squiggly-underline font-semibold text-black">land on the desk,</span>
        ...
        <br />
        <div v-if="isLoading" class="loading-container" style="display: flex; justify-content: center; height: 200px">
            <Spinner borderWidth="3px" style="margin: auto 0px" />
        </div>
        <div v-else class="pricing-page__grid flex justify-center flex-wrap gap-14">
            <PricingCard v-for="plan in pricedPlans" :key="plan.name" :plan="plan" :is-popular="plan.isPopular"
                @select-plan="handlePlanSelection" :isDisabled="disablePlan(plan)" />
        </div>
            ...
            <div class="mx-auto">
                <div class="bg-gray-50 border border-gray-400 rounded p-6">
                    ...
                    <div class="flex items-center flex-wrap gap-6 mb-2">
                        <div v-for="feature in freePlanFeatures" :key="feature"
                            class="flex items-center font-medium text-sm text-gray-800">
                            <span
                                class="w-5 h-5 bg-violet-200/70 rounded-full flex items-center justify-center text-black font-semibold text-xs mr-2">✓</span>
                            {{ feature }}
                        </div>
                    </div>
                </div>
        ...
        <div class="pricing-page__comparison mt-30 pb-0">
            ...
            <div class="comparison-table">
                ...
                <div class="comparison-row" v-for="(feature, index) in comparisonFeatures" :key="index">
