<template>
  <div class="flex flex-col h-screen w-full">
    ...
    <div
      class="flex-1 flex flex-col lg:flex-row overflow-hidden mx-auto w-full max-w-[1000px]"
      :class="{ 'overflow-y-auto justify-between': isExtensionMode }"
    >
      <!-- Left: Resume Preview -->
...
const optimizeResume = async () => {
  ...
  try {
    ...
    console.log("🚀 ~ optimizeResume ~ body:", body);

    const response = await fetch(`${API_BASE_URL}/resume/tweak`, {
      method: "POST",
      headers: {
